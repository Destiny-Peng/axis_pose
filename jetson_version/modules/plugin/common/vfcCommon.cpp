...
extern "C" DEPLOYAPI IPluginCreatorInterface* const* getCreators(int32_t& nbCreators) {
    ...
    static IPluginCreatorInterface* const kPLUGIN_CREATOR_LIST[] = {&efficientIdxNMSPluginCreator};
...
extern "C" DEPLOYAPI IPluginCreator* const* getPluginCreators(int32_t& nbCreators) {
    nbCreators = 2;
    static EfficientIdxNMSPluginCreator efficientIdxNMSPluginCreator;
    static IPluginCreator* const        kPLUGIN_CREATOR_LIST[] = {&efficientIdxNMSPluginCreator};
    return kPLUGIN_CREATOR_LIST;
}
#endif
